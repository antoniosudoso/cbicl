...
void save_X_to_file(arma::sp_mat &X, std::string &type){

    std::ofstream f;
    std::string result_path_str(result_path);
    f.open(result_path_str + "_" + type + ".txt");
...
void print_log_sdp(int n, int m, int node_parent, int node, double ub_parent, double ub, double time,
                   int cp_iter, int cp_flag, int n_ineq, double lb, double htime, double glb, int type, int i, int j,
